...
public class Pattern2x2Item extends AbstractPatternItem {
    private static final Map<Ingredient, CraftingRecipe> RECIPES = new HashMap<>();
    public Pattern2x2Item(Properties pProperties) {
        super(pProperties);
    ...
    public ItemStack cycleItem() {
        return new ItemStack(Registration.SLATE_UNPACKAGE.get(),1);
    }
}
