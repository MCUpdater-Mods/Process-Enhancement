...
public class PatternWallItem extends AbstractPatternItem {
    private static final Map<Ingredient, CraftingRecipe> RECIPES = new HashMap<>();
    public PatternWallItem(Properties pProperties) {
        super(pProperties);
    ...
    public ItemStack cycleItem() {
        return new ItemStack(Registration.SLATE_STAIR.get(),1);
    }
}
