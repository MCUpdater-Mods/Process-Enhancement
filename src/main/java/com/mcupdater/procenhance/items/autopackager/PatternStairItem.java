...
public class PatternStairItem extends AbstractPatternItem {
    private static final Map<Ingredient, CraftingRecipe> RECIPES = new HashMap<>();
    private static final Set<Integer> exclusions = Set.of(1,2,5);
    public PatternStairItem(Properties pProperties) {
        super(pProperties);
    ...
    public ItemStack cycleItem() {
        return new ItemStack(Registration.SLATE_DOOR.get(),1);
    }
}
