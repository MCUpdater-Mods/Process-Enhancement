...
public class PatternDoorItem extends AbstractPatternItem {
    private static final Map<Ingredient, CraftingRecipe> RECIPES = new HashMap<>();
    public PatternDoorItem(Properties pProperties) {
        super(pProperties);
        this.ingredientCount = 6;
    }
    ...
    public ItemStack cycleItem() {
        return new ItemStack(Registration.SLATE_CROSS.get(),1);
    }
}
