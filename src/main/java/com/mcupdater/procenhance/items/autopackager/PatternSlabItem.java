...
public class PatternSlabItem extends AbstractPatternItem {
    private static final Map<Ingredient, CraftingRecipe> RECIPES = new HashMap<>();
    public PatternSlabItem(Properties pProperties) {
        super(pProperties);
    ...
    public ItemStack cycleItem() {
        return new ItemStack(Registration.SLATE_WALL.get(),1);
    }
}
