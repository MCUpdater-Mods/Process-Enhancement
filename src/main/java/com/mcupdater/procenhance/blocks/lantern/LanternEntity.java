...
public class LanternEntity extends AbstractMachineBlockEntity {
	...
	public ContainerData data = new ContainerData() {
		...
		public int get(int index) {
			switch (index) {
				case 0:
					return LanternEntity.this.workProgress;
				case 1:
					return LanternEntity.this.workTotal;
				default:
					return 0;
			}
		}
		...
		public void set(int index, int newValue) {
			switch (index) {
				case 0:
					LanternEntity.this.workProgress = newValue;
				case 1:
					LanternEntity.this.workTotal = newValue;
			}
		}
