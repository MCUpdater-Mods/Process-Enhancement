...
public class CopperLanternEntity extends AbstractMachineBlockEntity {
	...
	public ContainerData data = new ContainerData() {
		...
		public int get(int index) {
			switch (index) {
				case 0:
					return CopperLanternEntity.this.workProgress;
				case 1:
					return CopperLanternEntity.this.workTotal;
				default:
					return 0;
			}
		}
		...
		public void set(int index, int newValue) {
			switch (index) {
				case 0:
					CopperLanternEntity.this.workProgress = newValue;
				case 1:
					CopperLanternEntity.this.workTotal = newValue;
			}
		}
	...
	public CopperLanternEntity(BlockPos blockPos, BlockState blockState) {
		super(COPPER_ELECTRIC_LANTERN_ENTITY.get(), blockPos, blockState, 1000, 5, 1, 1);
	}
