...
public class BatteryScreen extends AbstractContainerScreen<BatteryMenu> {
    ...
    private static final ResourceLocation GUI = ResourceLocation.fromNamespaceAndPath(ProcessEnhancement.MODID, "textures/gui/battery.png");
    private ConfigPanel configPanel;
    private TabConfig configTab;
    public BatteryScreen(BatteryMenu pMenu, Inventory pInventory, Component pName) {
