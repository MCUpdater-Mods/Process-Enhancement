...
public class DeconstructorScreen extends AbstractMachineScreen<DeconstructorEntity, DeconstructorMenu> {
    private static final ResourceLocation GUI = ResourceLocation.fromNamespaceAndPath(ProcessEnhancement.MODID, "textures/gui/deconstructor.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        if (((AbstractMachineMenu)this.menu).isWorking()) {
            ...
            guiGraphics.blit(this.getGUIResourceLocation(), relX + 61, relY + 36, 176, 0, progress, 18);
        }
    }
