...
public class HarvesterMenu extends AbstractMachineMenu<HarvesterEntity> {
    ...
    public HarvesterMenu(int id, Level level, BlockPos blockPos, Inventory inventory, Player player, ContainerData data, Map<Direction, Component> adjacentNames) {
        super((HarvesterEntity) level.getBlockEntity(blockPos), Registration.AUTOPACKAGER_MENU.get(), id, level, blockPos, inventory, player, data, adjacentNames);
