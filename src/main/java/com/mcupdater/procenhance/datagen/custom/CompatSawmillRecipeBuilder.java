...
public class CompatSawmillRecipeBuilder implements RecipeBuilder {
    ...
    public CompatSawmillRecipeBuilder(String modId, Ingredient input, ItemLike output, int count, int processTime, float experience) {
        this.modId = modId;
        this.input = input;
    ...
    @Override
    public CompatSawmillRecipeBuilder unlockedBy(String criterionName, CriterionTriggerInstance criterionTriggerInstance) {
    ...
    public void save(Consumer<FinishedRecipe> finishedRecipeConsumer, ResourceLocation recipeId) {
        ...
        finishedRecipeConsumer.accept(new CompatSawmillRecipeBuilder.Result(recipeId, this.output, this.count, this.input, this.processTime, this.experience, this.advancement, new ResourceLocation(recipeId.getNamespace(),"recipes/sawmill/" + this.output.getItemCategory().getRecipeFolderName() + "/" + recipeId.getPath()), modId));
    }
    ...
    public class Result implements FinishedRecipe {
        ...
        public Result(ResourceLocation recipeId, Item output, int count, Ingredient input, int processTime, float experience, Advancement.Builder advancement, ResourceLocation advancementId, String modId) {
        ...
        public ResourceLocation getId() {
            ...
            return new ResourceLocation(ProcessEnhancement.MODID, "compat/"+ modId +"/sawmill/" + ForgeRegistries.ITEMS.getKey(this.output).getPath() + "_from_" + source);
        }
