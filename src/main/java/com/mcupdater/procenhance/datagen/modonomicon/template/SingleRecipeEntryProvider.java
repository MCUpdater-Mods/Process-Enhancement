...
public class SingleRecipeEntryProvider extends EntryProvider {
	...
	public SingleRecipeEntryProvider(CategoryProvider parent, Item item, String baseId, String baseName, String description, String recipeInfo, String entryDescription, String recipePrefix) {
		super(parent);
		this.entryId = baseId;
	...
	public SingleRecipeEntryProvider(CategoryProvider parent, Item item, String baseId, String baseName, String description, String recipeInfo, String entryDescription, ResourceLocation recipeOverride) {
		super(parent);
		this.entryId = baseId;
		this.baseName = baseName;
		this.description = description;
